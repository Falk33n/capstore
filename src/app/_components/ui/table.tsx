...
>(({ className, ...props }, ref) => (
  <div className='relative mb-24 w-full rounded-lg border'>
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b transition-colors odd:bg-muted/40 hover:bg-muted/80 hover:odd:bg-muted data-[state=selected]:bg-muted',
      className
    )}
    {...props}
  />
